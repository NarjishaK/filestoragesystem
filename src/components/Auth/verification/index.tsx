    ...
    if (email) {
      ...
      try {
        const response = await fetch(
          `${BASE_URL}/customer/resend-verification`,
          {
            method: "POST",
            headers: {
          ...
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
              <div className="text-center">
                <div className="mb-8">
                  <svg
                    className="mx-auto h-16 w-16 text-blue mb-4"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div className="mb-8">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    ...
                    <ol className="text-sm text-blue-700 text-left space-y-2">
                      ...
                      <li>
                        2. Look for an email with the subject "Email
                        Verification - Complete Your Registration"
                      </li>
